...
export default function ChatScreen() {
	...
	return (
        ...
        <View style={{ maxWidth: 1000 }}>
			...
			<Card>
				<VStack>
					<Text style={{  }} variant="heading">ServiceSaver-AI</Text>
					...
					{messages.length <= 1 && <View style={{ alignItems: 'center'}}>
						<Text style={{ fontSize: 14, padding: 20, maxWidth: 800, lineHeight: 20 }}>
							Hi, this is ServiceSaver-AI your one stop shop for all negotiations. We here at Eyecognito know how
					...
					<MessageBox isIncoming={true}
						message="Hi, I'm ServiceSaver-AI. Your AI negotiation expert. Let's start by answering some questions about your move."
