...
const BASE_URL = __DEV__ ? 'http://127.0.0.1:8000' : 'https://servicesaver-ai.web.app';
...
//         role: 'system',
//         content: `You are ServiceSaver-AI an AI agent that helps in collection of information about the user in the home moving.
